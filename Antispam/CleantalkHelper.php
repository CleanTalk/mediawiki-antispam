...
class CleantalkHelper
{
	...
	/**
	 * Returns primary database connection (MW < 1.46 via wfGetDB, MW >= 1.46 via services).
	 *
	 * @return \Wikimedia\Rdbms\IDatabase|\Wikimedia\Rdbms\IMaintainableDatabase
	 */
	public static function getPrimaryDatabase() {
